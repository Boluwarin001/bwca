    ...
    <div className="min-h-screen  ">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 rounded-full border-2 border-emerald-200 dark:border-emerald-800 flex items-center justify-center">
            ...
            <div className="inline-flex items-center px-4 py-2 border border-emerald-200 dark:border-emerald-800 rounded-full text-emerald-700 dark:text-emerald-300">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="space-y-10">
          {/* Our Commitment */}
          <section className="border border-slate-200 dark:border-slate-700 rounded-xl p-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="border-2 border-emerald-200 dark:border-emerald-700 rounded-lg p-6">
          ...
          <section className="border border-slate-200 dark:border-slate-700 rounded-xl p-8">
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-6 flex items-center">
              <Clock className="w-6 h-6 text-emerald-600 dark:text-emerald-400 mr-3" />
            ...
            <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-6">
              ...
              <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                <li className="flex items-start">
                  <span className="w-2 h-2 rounded-full bg-slate-400 dark:bg-slate-500 mr-3 mt-2"></span>
          ...
          <section className="border border-slate-200 dark:border-slate-700 rounded-xl p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="w-8 h-8 rounded-full border-2 border-emerald-200 dark:border-emerald-700 flex items-center justify-center mr-4 flex-shrink-0 mt-1">
          ...
          <section className="border border-slate-200 dark:border-slate-700 rounded-xl p-8">
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-4">
              We understand that life can present unexpected challenges. If you&apos;e facing special circumstances such as:
            </p>
